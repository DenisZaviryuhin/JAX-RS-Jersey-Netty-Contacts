...
import org.example.app.domain.Contact;
...
public class ContactRepository implements AppRepository<Contact> {
    ...
    public void create(Contact contact) {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            String hql = "INSERT INTO Contact (contactName, phone) " +
                    "VALUES (:contactName, :phone)";
    ...
    public void update(Long id, Contact contact) {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            transaction = session.beginTransaction();
            String hql = "UPDATE Contact SET contactName = :contactName," +
                    " phone = :phone" +
                    " WHERE id = :id";
            MutationQuery query = session.createMutationQuery(hql);
            query.setParameter("contactName", contact.getContactName());
